 ...
 */
public class WaiterViewOrderedMeals extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       if (isNetworkAvailable()){
           ...
           firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<OrderedMealListModel, WaiterViewOrderedViewHolder>(
                   OrderedMealListModel.class,R.layout.ordered_meal_details,WaiterViewOrderedViewHolder.class,mReference
           ) {
               @Override
